...
const EN = {
  ...
  exitWrListen: "You did not force the vote",
  exitUsVillages: "You made him spend on the villages",
  exitFordMix: "You split the invoice",
  exitImamLives: "The Imam lives",
  exitNukes: "Breakout hit zero",
  moralVictories: "Moral victories",
  moralBlurb:
    "Convenience stores and book deals. The split is on the meters. It's a moral victory. But the machinery grinds on.",
...
const FA: { [K in keyof typeof EN]: string } = {
  ...
  exitWrListen: "رأی را تحمیل نکردی",
  exitUsVillages: "او را واداشتی خرج روستاها کند",
  exitFordMix: "فاکتور را نصف کردی",
  exitImamLives: "امام زنده است",
  exitNukes: "گریز به صفر رسید",
  moralVictories: "پیروزی‌های اخلاقی",
  moralBlurb:
    "سوپرمارکت و کتاب. تفکیک روی مترهاست. پیروزی اخلاقی است. اما ماشین ادامه می‌دهد.",
