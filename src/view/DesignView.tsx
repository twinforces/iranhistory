const QUESTIONS: { q: string; freeze: string }[] = [
  ...
  },
  {
    q: "How much 1953-78?",
    freeze:
      "Split. Atoms for Peace (Ike: keep the fuel, or let them sprint now), White Revolution (Kennedy: press, or do not force the vote), the SOFA (Johnson: Vietnam is why you barely looked, and why Khomeini has a name), Twin Pillars (Nixon: Britain left east of Suez, no more Vietnams, oil-funded policeman, or make him spend on the villages), the pipeline (Ford: keep selling, or split the invoice fifty-fifty), Carter (stay out of the war, hostages are the exam, Desert One if you authorize the raid, then the Saudis lining Saddam up), Reagan (February 1982: Iraq off the terrorism list so the chemistry can move, then the intel tilt, then Beirut). Iran's Beirut briefing is the sermon: they gave Saddam chemistry and a nuke plant, they cannot be trusted, Death to Europe. That is IT, not a cable. 1953 titles split by chair: Danger: Coup! in Tehran, To Coup or Not to Coup on Ike's desk. Urban liberals are a clock. Khomeini uses them in 1979 and kills them. Combined 'muddles along' copy lives on the 1972 card. A sit-Nixon funnel is a waste of a card. Quiet Next cards are tutorial stops. Do not skip years that have a fork.",
  },
  {
    q: "Cartoons per rant",
    freeze:
